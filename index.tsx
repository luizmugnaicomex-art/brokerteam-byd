        ...
        const unsubscribeAuth = auth.onAuthStateChanged(async (userAuth: any) => {
            if (userAuth) {
                ...
                if (userDoc.exists) {
                    ...
                    console.error("User document not found in Firestore for UID:", userAuth.uid);
                    setLoginError("Your user profile is missing or corrupted. Please contact an administrator.");
                    auth.signOut();
                }
            } else {
